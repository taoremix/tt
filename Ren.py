...
helpMessage ="""By:꧁°‧:.❝s̶ᴇ̶ʟ̶ғ̶ʙ̶ᴏ̶ᴛ̶ʀ̶ᴀ̶ɪ̶и̶в̶o̶w̶❞.:‧°꧂
  
   ╔•═•-⊰❉⊱•═•⊰❉⊱•═•⊰❉⊱ •═•╗
   ║°‧:.❝s̶ᴇ̶ʟ̶ғ̶ʙ̶ᴏ̶ᴛ̶ʀ̶ᴀ̶ɪ̶и̶в̶o̶w̶❞.:‧° ║
   ╚•═•-⊰❉⊱•═•⊰❉⊱•═•⊰❉⊱ •═•╝
╔═════════
║🍁 『คท』 =  แสดงคอนแท๊ก
║🍁 『ไอดี』=  แสดงไอดีเรา
...
💨 『Namelock On/off』
        ...
        ─┅═✥ᵀᴴᴬᴵᴸᴬᴺᴰ✥═┅─
      http://line.me/ti/p/~stara456789zax
      [By:꧁°‧:.❝s̶ᴇ̶ʟ̶ғ̶ʙ̶ᴏ̶ᴛ̶ʀ̶ᴀ̶ɪ̶и̶в̶o̶w̶❞.:‧°꧂]
...
╠═══════════════
║✔ JT1 on ➠เปิดข้อความต้อนรับ
║✖ JT1 off ➠ปิดข้อความต้อนรับ
║✔ JT2 on ➠เปิดข้อความออกกลุ่ม
║✖ JT2 off ➠เปิดข้อความออกกลุ่ม
║✔ JT3 on ➠เปิดข้อความคนลบ
║✖ JT3 off ➠เปิดข้อความคนลบ
...
║         โหมดตั้งค่าข้อความ
╠═══════════════
║💢 JT1˓: ➠ไส่ข้อความต้อนรับ
║💢 JT2˓: ➠ไส่ข้อความออกจากกลุ่ม
║💢 JT3˓: ➠ไส่ข้อความเมื่อมีคนลบ
╚═══════════════
╔════════════════
...
wait = {
    ...
    'message':"Thanks for add Me By:꧁°‧:.❝s̶ᴇ̶ʟ̶ғ̶ʙ̶ᴏ̶ᴛ̶ʀ̶ᴀ̶ɪ̶и̶в̶o̶w̶❞.:‧°꧂",
    "lang":"JP",
    "comment":"AutoLike by เร็นโบว์",
    "commentOn":False,
    "acommentOn":False,
    "bcommentOn":False,
    "ccommentOn":False,
    ...
    "dblack":False,
    "clock":False,
    "cName":"꧁°‧:.❝s̶ᴇ̶ʟ̶ғ̶ʙ̶ᴏ̶ᴛ̶ʀ̶ᴀ̶ɪ̶и̶в̶o̶w̶❞.:‧°꧂",
    "likeOn":False,
    "pname":False,
    "blacklist":{},
    "whitelist":{},
...
#----------------------------------------------------------------------------
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to,"Add Line https://line.me/ti/p/~xcool.py")
...
#==================================================
            ...
            elif msg.text in ["มาหำ","คิกมา","#kicker","Kicker","kicker","•••","โม่"]:
                ...
                cl.sendText(msg.to,"""[꧁°‧:.❝s̶ᴇ̶ʟ̶ғ̶ʙ̶ᴏ̶ᴛ̶ʀ̶ᴀ̶ɪ̶и̶в̶o̶w̶❞.:‧°꧂]\n\n
คำสั่งบอท siri
...
#==================================================
                ...
                cl.sendText(msg.to,""" 􀜁􀇔􏿿􀜁􀇔􏿿[꧁°‧:.❝s̶ᴇ̶ʟ̶ғ̶ʙ̶ᴏ̶ᴛ̶ʀ̶ᴀ̶ɪ̶и̶в̶o̶w̶❞.:‧°꧂] 􀜁􀇔􏿿􀜁􀇔􏿿 \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb1 in]\n􀜁􀇔􏿿[1Aditname:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Pb1 Gift]\n􀜁􀇔􏿿[Pb1 bye]\n\n
""")
...
#========================================
                ...
                md = "By:꧁°‧:.❝s̶ᴇ̶ʟ̶ғ̶ʙ̶ᴏ̶ᴛ̶ʀ̶ᴀ̶ɪ̶и̶в̶o̶w̶❞.:‧°꧂\n\n"
...
#-----------------------------------------------
            ...
            elif msg.text in ["Add:on","Auto add on","Auto add:on","เปิดกันรัน"]:
                if wait["autoAdd"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Sudah on Bosqu")
                    else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Sudah on Bosqu")
            elif msg.text in ["Add:off","Auto add off","Auto add:off","ปิดกันรัน"]:
...
#===============================================
                ...
                ki.sendText(msg.to, "[꧁°‧:.❝s̶ᴇ̶ʟ̶ғ̶ʙ̶ᴏ̶ᴛ̶ʀ̶ᴀ̶ɪ̶и̶в̶o̶w̶❞.:‧°꧂]\n\n❂͜͡☆➣ Namelock on\n❂͜͡☆➣ Namelock off\n❂͜͡☆➣ Blockinvite on\n❂͜͡☆➣ Blockinvite off\n❂͜͡☆➣ Backup on\n❂͜͡☆➣ Backup off\n\n[By.꧁°‧:.❝s̶ᴇ̶ʟ̶ғ̶ʙ̶ᴏ̶ᴛ̶ʀ̶ᴀ̶ɪ̶и̶в̶o̶w̶❞.:‧°꧂]")
...
#=================================================
                ...
                if msg.from_ in admin:
                   txt = msg.text.split(" ")
                   jmlh = int(txt[2])
                   teks = msg.text.replace("JT "+str(txt[1])+" "+str(jmlh)+ " ","")
                   tulisan = jmlh * (teks+"\n")
                   #Keke cantik <3
                   if txt[1] == "on":
                        if jmlh <= 10000:
...
#-------------------------------------------------
                ...
                msg.contentType = 13
                cl.sendText(msg.to, "Ŧ€₳ℳ฿❂Ŧ ✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ ")
                msg.contentMetadata = {'mid': 'uab7c5ac3a62c68ec1a729bc1d944e8d7'}
                cl.sendMessage(msg)                                                                                
                cl.sendText(msg.to, "Ŧ€₳ℳ฿❂Ŧ꧁°‧:.❝s̶ᴇ̶ʟ̶ғ̶ʙ̶ᴏ̶ᴛ̶ʀ̶ᴀ̶ɪ̶и̶в̶o̶w̶❞.:‧°꧂")                                                 
                msg.contentMetadata = {'mid': 'ua11927d673a2ae7bab9c737e4bd206d2'}
                cl.sendMessage(msg)
                #cl.sendText(msg.to, "")
                #msg.contentMetadata = {'mid': 'ua1cb6e845fe8f2646fe8a5c5911841fa'}
                #cl.sendMessage(msg)
                #cl.sendText(msg.to, "Ŧ€₳ℳ฿❂Ŧ")
        ...
        if op.type == 26:
            ...
            if msg.text.lower() in ["1123"]:
                ...
                cl.sendMessage(cnt)
                        ...
                        cl.sendText(msg.to,"อยู่นี้ยังไม่ตายไม่หายไปไหนหรอก")       
            elif "." == msg.text.lower():
                if msg.to in wait2['readPoint']:
                        try:
                            del wait2['readPoint'][msg.to]
