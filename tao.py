...
╔═════════════════════
║           [By.✯͜͜͡✯ຖ ຸงເທ ົາ✯͜͜͜͡✯]
║  ติดต่อ [LINE ID :  xcool.py]
╚═════════════════════
ลิ้ง:  http://line.me/ti/p/~xcool.py
──┅═✥===========✥═┅──
helpMessage2 =""
╔═════════════════════
║                [SELF BOT]
...
╚═════════════════════
╠🌠➣〘Help admin〙
╠🌠➣〘ชุดคำสั่งข้อความต้อนรับ〙
╠🌠➣〘Help self〙
╠🌠➣〘Help group〙
╠🌠➣〘Help setting〙
╠🌠➣〘Help media〙
╠🌠➣〘Help en〙~คำสั่งอังกฤษ
╠🌠➣〘Help th〙~คำสั่งภาษาไทย
"""
helpMessage3 ="""
╔═════════════════════
║                [SELF BOT]
...
║           [By.✯͜͜͡✯ຖ ຸงເທ ົາ✯͜͜͜͡✯]
╚═════════════════════
   •คำสั่งเปิด/ปิดข้อความต้อนรับ•

╠🌠➣  M on =ข้อความต้อนรับ
╠🌠➣  M off =ข้อความต้อนรับ
╠🌠➣  Hhx2 on =ข้อความออกกลุ่ม
╠🌠➣  Hhx2 off =ข้อความออกกลุ่ม
╠🌠➣  Hhx3 on =ข้อความคนเตะกัน
╠🌠➣  Hhx3 off =ข้อความคนเตะกัน
...
🌠➣  รันแชท @ - รันแชทส่วนตัวของคนที่เราแทค
...
🌠➣  M off =ข้อความต้อนรับ
🌠➣  Hhx2 on =ข้อความออกกลุ่ม
🌠➣  ️Hhx2 off =ข้อความออกกลุ่ม
🌠➣ ️ Hhx3 on =ข้อความคนเตะกัน
🌠➣ ️ Hhx3 off =ข้อความคนเตะกัน
🌠➣  Mbot on = เปิดเเจ้งเตือนบอท
...
#----------------------------------------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    for jj in matched_list:
                        ...
                        pass
            elif msg.text.lower() in ["ติดต่อ","ผู้สร้าง"]:
                msg.contentType = 13
                adm = 'uab7c5ac3a62c68ec1a729bc1d944e8d7'
                msg.contentMetadata = {'mid': adm}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"Add Line http://line.me/ti/p/~xcool.py")
...
#==================================================
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    ki.updateProfile(profile)
            elif msg.text in ["เข้ามา","มาหำ","คิกมา"]:
                        ...
                        G.preventJoinByTicket(G)
                        ki1.updateGroup(G)
            elif msg.text in ["คิกออก","บายหำ","หำออก"]:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ...
                        ki7.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\[By.✯͜͜͡✯ຖ ຸงເທ ົາ✯͜͜͜͡✯]")
                        ki7.leaveGroup(msg.to)
                        ki8.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\[By.✯͜͜͡✯ຖ ຸงເທ ົາ✯͜͜͜͡✯]")
                        ki8.leaveGroup(msg.to)
                        ki9.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\[By.✯͜͜͡✯ຖ ຸงເທ ົາ✯͜͜͜͡✯]")
...
#==================================================
				...
				msg.contentMetadata = {'mid': mid}
				cl.sendMessage(msg)
				cl.sendText(msg.to,"[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
            elif "Id" == msg.text:
                key = msg.to
                ...
                cl.sendText(msg.to,""" 􀜁􀇔􏿿􀜁􀇔􏿿[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]􀇔􏿿􀜁􀇔􏿿 \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb1 in]\n􀜁􀇔􏿿[1Aditname:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Pb1 Gift]\n􀜁􀇔􏿿[Pb1 bye]\n\n
""")
...
#========================================
                ...
                md = "〚[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]\n\n"
                if wait["likeOn"] == True: md+="╠☬➣  Auto like ➣ ✔\n"
                else:md+="╠☬➣  Auto like ➣ ️❌\n"
                if wait["alwayRead"] == True: md+="╠☬➣  Read ➣ ️✔\n"
                else:md+="╠☬➣  Read ➣ ️❌\n"
                if wait["detectMention"] == True: md+="╠☬➣ Autorespon ➣ ️✔\n"
                else:md+="╠☬➣ Autorespon ➣ ️❌\n"
                if wait["detectMention3"] == True: md+="╠☬➣ Autorespon3 ➣ ️✔\n"
                else:md+="╠☬➣  Autorespon3 ➣ ❌\n"             
                if wait["kickMention"] == True: md+="╠☬➣  Autokick ➣ ️✔\n"
                else:md+="╠☬➣  Autokick ➣ ️❌\n"
                if wait["Notifed"] == True: md+="╠☬➣  Notifed ➣ ✔\n"
                else:md+="╠☬➣  Notifed ➣ ❌\n"
                if wait["Notifedbot"] == True: md+="╠☬➣  Notifedbot ➣ ✔\n"
                else:md+="╠☬➣  Notifedbot ➣ ❌\n"
                if wait["acommentOn"] == True: md+="╠☬➣  Hhx1 ➣ ️✔\n"
                else:md+="╠☬➣  Hhx1 ➣ ❌\n"
                if wait["bcommentOn"] == True: md+="╠☬➣  Hhx2 ➣ ✔\n"
                else:md+="╠☬➣  Hhx2 ➣ ️❌\n"
                if wait["ccommentOn"] == True: md+="╠☬➣  Hhx3 ➣ ✔\n"
                else:md+="╠☬➣  Hhx3 ➣ ❌\n"
                if wait["Protectcancl"] == True: md+="╠☬➣  Cancel ➣ ️✔\n"
                else:md+="╠☬➣  Cancel ➣ ❌\n"
                if wait["winvite"] == True: md+="╠☬➣  Invite ➣ ✔\n"
                else:md+="╠☬➣  Invite ➣ ❌\n"
                if wait["pname"] == True: md+="╠☬➣  Namelock ➣ ️✔\n"
                else:md+="╠☬➣  Namelock ➣ ️❌\n"
                ...
                else: md+= "╠☬➣  Group cancel ➣ ️❌\n"
                if wait["leaveRoom"] == True: md+="╠☬➣  Auto leave ➣ ️✔\n"
                else: md+="╠☬➣  Auto leave ➣ ❌\n"
                if wait["timeline"] == True: md+="╠☬➣  Share ➣ ️✔\n"
                else:md+="╠☬➣  Share ➣ ️❌\n"
                if wait["clock"] == True: md+="╠☬➣  Clock Name ➣ ✔\n"
                else:md+="╠☬➣  Clock Name ➣ ️❌\n"
                ...
                if wait["detectMention"] == True: md+="╠☬➣  การตอบรับ ➣ ✔\n"
                else:md+="╠☬➣  การตอบรับ ➣   ❌\n"
                if wait["detectMention3"] == True: md+="╠☬➣  การตอบรับ3 ➣ ✔\n"
                else:md+="╠☬➣  การตอบรับ3 ➣   ❌\n"
                if wait["kickMention"] == True: md+="╠☬➣  เตะออโต้ ➣  ✔\n"
                else:md+="╠☬➣  เตะออโต้ ➣   ❌\n"
                if wait["Notifed"] == True: md+="╠☬➣  แจ้งเตืิอนตนเอง ➣  ✔\n"
                else:md+="╠☬➣  แจ้งเตือนตนเอง ➣   ❌\n"
                if wait["Notifedbot"] == True: md+="╠☬➣  แจ้งเตือนบอท ➣  ✔\n"
                else:md+="╠☬➣  แจ้งเตือนบอท ➣   ❌\n"
                if wait["acommentOn"] == True: md+="╠☬➣  ข้อความคนเข้า ➣ ✔\n"
                else:md+="╠☬➣  ข้อความคนเข้า ➣   ❌\n"
                if wait["bcommentOn"] == True: md+="╠☬➣  ข้อความคนออก ➣  ✔\n"
                else:md+="╠☬➣  ข้อความคนออก ➣   ❌\n"
                if wait["ccommentOn"] == True: md+="╠☬➣  ข้อความคนเตะกัน ➣  ✔\n"
                else:md+="╠☬➣  ข้อความคนเตะกัน ➣   ❌\n"
                if wait["Protectcancl"] == True: md+="╠☬➣  ป้องกันการยกเลิกเชิญ ➣  ✔\n"
                else:md+="╠☬➣  ป้องกันการยกเลิกเชิญ ➣   ❌\n"
                if wait["winvite"] == True: md+="╠☬➣  ป้องกันการเชิญ ➣  ✔\n"
                else:md+="╠☬➣  ป้องกันการเชิญ ➣   ❌\n"
                ...
                else: md+= "╠☬➣  ยกเลิกการเชิญกลุ่ม ➣   ❌\n"
                if wait["leaveRoom"] == True: md+="╠☬➣  ป้องกันการดึงแชท ➣  ✔\n"
                else: md+="╠☬➣  ป้องกันการดึงแชท ➣   ❌\n"
                if wait["timeline"] == True: md+="╠☬➣  แชร์อัตโนมัติ ➣  ✔\n"
                else:md+="╠☬➣  แชร์อัตโนมัติ ➣   ❌\n"
                if wait["clock"] == True: md+="╠☬➣  ชื่อเวลา ➣  ✔\n"
                else:md+="╠☬➣  ชื่อเวลา ➣   ❌\n"
                if wait["autoAdd"] == True: md+="╠☬➣  รับแอดอัตโนมัติ ➣  ✔\n"
                else:md+="╠☬➣  รับแอดอัตโนมัติ ➣   ❌\n"
                if wait["autoBlock"] == True: md+="╠☬➣  ออโต้บล็อค ➣  ✔\n"
                else:md+="╠☬➣  ออโต้บล็อค ➣   ❌\n"
                if wait["commentOn"] == True: md+="╠☬➣  คอมเม้น ➣  ✔\n"
                else:md+="╠☬➣  คอมเม้น ➣   ❌\n"
                if wait["Backup"] == True: md+="╠☬➣  การเชิญกลับ ➣  ✔\n"
                else:md+="╠☬➣  การเชิญกลับ ➣   ❌\n"
...
#========================================
            ...
            elif msg.text in ["HHX1","Hhx1","ข้อความต้อนรับ","เชค1"]:
                cl.sendText(msg.to,"[เช็คข้อความต้อนรับของคุณ]\n\n" + str(wait["acomment"]))

            elif msg.text in ["HHX2","Hhx2","ข้อความคนออกกลุ่ม","เชค2"]:
                cl.sendText(msg.to,"[เช็คข้อความกล่าวถึงคนออกจากกลุ่ม]\n\n" + str(wait["bcomment"]))

            elif msg.text in ["HHX3","Hhx3","ข้อความคนลบสมาชิก","เชค3"]:
            ...
            elif msg.text in ["Hhx1 on","เปิด1","เปิ.ดข้อความ1"]:
                if wait["acommentOn"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already on")
            elif msg.text in ["Hhx2 on","เปิดคนออกกลุ่ม","เปิด2"]:
                if wait["bcommentOn"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already on")
            elif msg.text in ["Hhx3 on","เปิดคนเตะกัน","เปิด3"]:
            ...
            elif msg.text in ["Hhx1 off","ปิด1","ปิดข้อความ1"]:
                if wait["acommentOn"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already off")
            elif msg.text in ["Hhx2 off","ปิด2","ปิดข้อความ2"]:
                if wait["bcommentOn"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already off")
            elif msg.text in ["Hhx3 off","ปิด3","ปิดข้อความ3"]:
...
#===============================================
                ...
                start = time.time()
                cl.sendText(msg.to, "[By.✯͜͜͡✯ຖ ຸงເທ ົາ✯͜͜͜͡✯]")
                ...
                elapsed_time = time.time() - start
                cl.sendText(msg.to, "[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ki1.sendText(msg.to, "[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ki2.sendText(msg.to, "[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ki3.sendText(msg.to, "[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ki4.sendText(msg.to, "[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ki5.sendText(msg.to, "[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ki6.sendText(msg.to, "[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ki7.sendText(msg.to, "[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ki8.sendText(msg.to, "[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ki9.sendText(msg.to, "[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
                ki10.sendText(msg.to, "[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]\nความเร็ว﴾%s﴿ต่อวินาที" % (elapsed_time))
...
#=================================================
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                       ...
                       cl.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       cl.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       cl.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       cl.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       cl.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki1.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki1.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki1.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki1.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki1.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki2.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki2.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki2.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki2.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki2.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki3.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki3.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki3.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki3.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki3.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki4.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki4.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki4.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki4.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki4.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki5.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki5.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki5.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki5.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                       ki5.sendText(g.mid,"〘[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
...
#-------------------------------------------------
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to, "เมียผู้สร้าง💕 SELFBOT\nBy.✯͜͜͡✯ຖ ຸงເທ ົາ✯͜͜͜͡✯")
                msg.contentMetadata = {'mid': 'u40f28986f8cfcc5a4abe926e5766aa20'}
                cl.sendMessage(msg)
                #cl.sendText(msg.to, "เมียผู้จัดการ\nBy.ผู้สร้างพญาไฟ")
                #msg.contentMetadata = {'mid': 'u40f28986f8cfcc5a4abe926e5766aa20'}
                #cl.sendMessage(msg)
...
#=============================================
            ...
            elif msg.text in ["Tag on","Autorespon:on","Respon on","Respon:on","เปิดแทค"]:
                wait["detectMention"] = True
                cl.sendText(msg.to,"Auto Respon ON")
                
            elif msg.text in ["Tag off","Autorespon:off","Respon off","Respon:off","ปิดแทค"]:
                wait["detectMention"] = False
                cl.sendText(msg.to,"Auto Respon OFF")
                
            elif msg.text in ["Tag3 on","Autorespon3:on","Respon3 on","Respon3:on","เปิดแทค3"]:
                wait["detectMention3"] = True
                cl.sendText(msg.to,"Auto Respon ON")
                
            elif msg.text in ["Tag3 off","Autorespon3:off","Respon3 off","Respon3:off","ปิดแทค3"]:
...
#==============================================================================#
            ...
            elif msg.text in [".เปิดอ่าน","ตั้งเวลา","แอบ"]:
...
#==============================================================================#
                ...
                try:
                    ...
                    cl.sendText(msg.to,"โปร " + contact.displayName)
                    cl.sendImageWithUrl(msg.to,image)
       ...
       #-------------Fungsi Respon Start---------------------#
        ...
        if op.type == 26:
            ...
            if msg.contentType == 16:
                ...
                print ("Auto Like  [By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")

            elif msg.text in [".คท",".Me"]:
                        cl.sendText(msg.to,"😆เช็คจัง กลัวบอทหลุด ล่ะสิ😆")

            elif msg.text in ["เทสบอท"]:
                        cl.sendText(msg.to,"SELF BOT\n[By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")

            elif msg.text in ["มอง",".มอง"]:
                        cl.sendText(msg.to,"มองเหี้ยไรเดะจิ้มตาแตกอิสัส..😂😂")
