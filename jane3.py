...
➣『เปิดป้องกัน』= เปิดป้องกันกลุ่ม
➣『ปิดป้องกัน』= ปิดป้องกันกลุ่ม
➣『รูป』 = รูปเรา
➣『ปก』= รูปปก เรา
...
wait = {
    ...
    "comment1":"""
     ...
     [By.τеaм✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ•°]
   http://line.me/ti/p/~xcool.py
   http://line.me/ti/p/~j-a-n-e-3737
   
 รับทำเชลบอทรายเดือนราคากันเอง
 รับติดตั้งบอทวี10 มีบอทแทคให้เช่ารายเดือน
 เชลบินรายครั้ง... ราคากันเอง...
 อื่นๆ สนใจติดต่อที่ลิ้งค์เลยครับ
            [ By.ถุงเท้า&ม๊าเจ]
...
#----------------------------------------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    for jj in matched_list:
                        ...
                        pass
            elif msg.text.lower() in ["admins","ติดต่อ"]:
                msg.contentType = 13
...
#========================================
                ...
                if wait["alwayRead"] == True: md+="􀬁􀆐􏿿╠☬➣ อ่านอัตโนมัติ : ✔ 􀜁􀄯??\n"
                else:md+="􀬁􀆐􏿿╠☬➣ อ่านอัตโนมัติ : ❌ 􀜁􀄰􏿿\n"
                ...
                if wait["Notifed"] == True: md+="􀬁􀆐􏿿╠☬➣ แจ้งเตือนตัวเอง : ✔ 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿╠☬➣ แจ้งเตือนตัวเอง : ❌ 􀜁􀄰􏿿\n"
                if wait["Notifedbot"] == True: md+="􀬁􀆐􏿿╠☬➣ แจ้งเตือนบอท : ✔ 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿╠☬➣ แจ้งเตือนบอท : ❌ 􀜁􀄰􏿿\n"
                if wait["acommentOn"] == True: md+="􀬁􀆐􏿿╠☬➣ ข้อความต้อนรับ : ✔ 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿╠☬➣ ข้อความต้อนรับ : ❌ 􀜁􀄰􏿿\n"
                if wait["bcommentOn"] == True: md+="􀬁􀆐╠☬➣ ข้อความคนออก : ✔ 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿╠☬➣ ข้อความคนออก : ❌ 􀜁􀄰􏿿\n"
                if wait["ccommentOn"] == True: md+="􀬁􀆐􏿿╠☬➣ ข้อความคนลบ : ✔ 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿╠☬➣ ข้อความคนลบ : ❌ 􀜁􀄰􏿿\n"
                ...
                if wait["contact"] == True: md+="􀬁􀆐􏿿╠☬➣ อ่านข้อมูล : ✔ 􀜁􀄯􏿿\n"
                else: md+="􀬁􀆐􏿿╠☬➣ อ่านข้อมูล : ❌ 􀜁􀄰􏿿\n"
                ...
                if wait["qr"] == True: md+="􀬁􀆐??╠☬➣ ป้องกัน QR : ✔ 􀜁􀄯􏿿\n"
...
#-------------------------------------------------
                ...
                msg.contentType = 13
                cl.sendText(msg.to, "τеaм✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ")
                cl.sendText(msg.to, "ผู้สร้างบอท ✯͜͜͡✯ຖ ຸงເທ ົາ✯͜͜͜͡✯")
                msg.contentMetadata = {'mid': 'uab7c5ac3a62c68ec1a729bc1d944e8d7'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "ผู้สร้าง 💕\nஆ๊ণℓन ചচ൮✬ŪЮط௭ี่ধՁ✬")
                msg.contentMetadata = {'mid': 'u40f28986f8cfcc5a4abe926e5766aa20'}
                cl.sendMessage(msg)
#                cl.sendText(msg.to, "ไม่มี")
...
#-----------------------------------------------------------
                ...
                if wait["blacklist"] == {}:
                    ...
                    #if msg.from_ in admin:
                        if wait["blacklist"] == {}:
                           cl.sendText(msg.to,"〘•👑ไม่มีบัญชีติดดำเรา👑•〙")
                        else:
...
#==============================================================================#
            ...
            elif msg.text in ["สมาชิก","Memlist","Nameall"]:   
                ...
                cl.sendText(msg.to, "[ชื่อของกลุ่มคือ : ]\n" + gid.name)
...
# ----------------- BAN MEMBER BY TAG 2TAG ATAU 10TAG MEMBER
       ...
       #-------------Fungsi Respon Start---------------------#
        ...
        if op.type == 26:
            ...
            elif msg.text in ["ดี","ดีล","สวัสดี","หวัดดี"]:
            ...
            elif msg.text in ["กำ","กำนะ"]:
                        cl.sendText(msg.to,"กำใดใครก่อคนนั้นต้องรับกำ..🙊🙊")
        ...
        if op.type == 15:
            if wait["Notifed"] == True:
                if op.param2 in Bots:
                    return
                cl.sendText(op.param1,cl.getContact(op.param2).displayName + "\nจะรีบไปไหนเร็วจังงง By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ")
        ...
        if op.type == 17:
            if wait["Notifedbot"] == True:
                ...
                image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
                cl.sendImageWithUrl(op.param1,image)
                cl.sendText(op.param1,cl.getContact(op.param2).displayName + "\n\n[🙋ยินดีตอนรับค่าา][By.✯͜͡ᴛᴀø͜͜͜͡✯sᴇʟғʙᴏᴛ]")
                print "MEMBER HAS JOIN THE GROUP"
